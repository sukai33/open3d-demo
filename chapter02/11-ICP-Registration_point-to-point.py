...
threshold为max_correspondence_distance两个对应点最大的距离
"""
print("Initial alignment 1")
...
"""
匹配身得分从0.174723增加到0.372450。 inlier_rmse从0.011771减少到0.007760。
默认情况下，registration_icp一直运行到收敛或达到最大迭代次数（默认为30）。 
可以更改它以允许更多的计算时间并进一步改善结果。
"""
